<?php
 ...
 $query="SELECT l.*, p.monthly_repayment_amount AS pamount, p.payee AS payee FROM loans l,loan_repayment p where l.loan_ID = p.loanID ";
			...
			<div class="card-body">
				<table class="table table-bordered" id=" loan-list">
					...
					<tr>
						...
						<td class="text-center"> 
							<button class="btn btn-outline-primary btn-sm edit_loan" type="button" id="edit_loan"><i class="fa fa-edit"></i></button>
